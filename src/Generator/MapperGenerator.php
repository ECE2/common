 ...
 */
class MapperGenerator extends BaseGenerator implements CodeGenerator
{
     ...
     */
    public function setGenInfo(SettingGenerateTable $model): MapperGenerator
    {
        $this->model = $model;
...
UseNamespace;
    ...
    {
        /* @var SettingGenerateColumn $model */
        $model = make(SettingGenerateColumnService::class)->mapper->getModel();
